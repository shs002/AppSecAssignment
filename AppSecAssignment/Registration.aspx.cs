    ...
    public partial class Registration : System.Web.UI.Page
    {
        ...
        public void createAccount()
        {
            try
            {
                ...
                {
                    using (SqlCommand cmd = new SqlCommand("INSERT INTO Table VALUES(@FirstName, @LastName, @CreditCardInfo, @Email, @PasswordHash, @PasswordSalt, @DateOfBirth, @EmailVerified, @IV, @Key"))
                    {
