...
namespace AppSecAssignment
{
    ...
    {
        string MyASDBConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["MyASDBConnection"].ConnectionString;
        ...
        protected string getDBHash(string userid)
        {
            ...
            SqlConnection conn = new SqlConnection(MyASDBConnectionString);
            string sql = "select PasswordHash FROM Table WHERE Email = @userid";
        ...
        protected string getDBSalt(string userid)
        {
            ...
            SqlConnection conn = new SqlConnection(MyASDBConnectionString);
            string sql = "Select PasswordSalt FROM Table WHERE Email = @userid";
            SqlCommand command = new SqlCommand(sql, conn);
            command.Parameters.AddWithValue("@Email", userid);
